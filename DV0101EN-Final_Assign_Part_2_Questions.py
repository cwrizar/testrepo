...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'textAlign': 'center', 'color': '#503D36', 'font-size': '24px'}),
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
                ...
                options=[
                           ...
                           {'label': 'Receession Period Statistics', 'value': 'Recession Period Staistics'}
                 ],
